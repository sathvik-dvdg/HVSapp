...
revision = '001_clinical_extensions'
down_revision = '73dad259939a'
branch_labels = None
depends_on = None
...
def upgrade():
    ...
    # Add new roles to existing ENUM (PostgreSQL-specific, must run outside transaction)
