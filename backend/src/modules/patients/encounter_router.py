...
from src.modules.patients.encounter_models import LabReportStatus
from src.modules.patients.encounter_schemas import (
    EncounterCreate, EncounterRead, EncounterUpdate, 
    LabStatusUpdate, CriticalAlerts
)
from src.modules.patients import encounter_service
